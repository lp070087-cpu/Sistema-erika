    ...
    <div className="space-y-6">
            ...
            <div className="space-y-4">
              <Secao rotulo="Blocos do diagnóstico" titulo="Como as respostas são agrupadas">
                <p className="text-[0.875rem] leading-relaxed text-[var(--tinta-suave)]">
                  ...
                  do relatório — se essa divisão está certa é uma decisão
                  sua, e ainda não foi tomada.
                </p>
      ...
      <Secao rotulo="Estado desta tela" titulo="O que funciona e o que depende de decisão">
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-4">
            <Aviso tom="atencao" titulo="A pontuação do diagnóstico depende de uma decisão sua">
              <p>
                A pontuação por bloco não está implementada, e isso é uma
                decisão — não uma pendência técnica. Ela exige o peso de cada
                resposta, e o peso de cada resposta é critério profissional
                seu: só quem faz o diagnóstico sabe se &quot;não controla
                ficha&quot; pesa mais que &quot;não mede rendimento&quot;.
              </p>
              <p className="mt-2.5">
                Enquanto isso não for definido, o diagnóstico mostra as
                respostas e os blocos a que pertencem, sem nota. Um score
                calculado com pesos inventados teria a aparência de um score
                certo.
              </p>
            </Aviso>
            <Aviso tom="info" titulo="A importação do Google Forms">
              <p>
                As respostas que você já recebeu ainda não podem ser
                importadas. Um importador teria que adivinhar como as colunas
                do Forms se ligam a cada pergunta — e erraria em silêncio,
                misturando resposta de um cliente com o campo de outro.
              </p>
              <p className="mt-2.5">
